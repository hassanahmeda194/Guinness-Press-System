        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom-0 d-flex justify-content-between">
                    <div>
                        <h4 class="card-title fs-4 fw-semibold">Blogs</h4>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-2">
                            <a href="{{ route('admin.blog.create') }}" class="btn btn-primary waves-effect waves-light">
                                <i class="fa fa-plus-circle me-2"></i>Add new Blog</a>
                        </div>
                        ...
                        <tbody>
                            @foreach ($blogs as $b)
                                <tr>
                                    ...
                                    <td>{{ Str::limit($b->title) }}</td>
                                    <td>{{ $b->category }}</td>
                                    <td>{{ \Carbon\Carbon::parse($b->published_at)->format('Y, M d, H:i:s') }}</td>
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-sm"
                                            href="{{ route('admin.blog.delete', ['id' => $b->id]) }}">
