                ...
                <div class="col-md-12">
                    <div class="banner_content white_text">
                        ...
                        <p class="poppins_fonts">
                            Guinness Press equips learners, thinkers, and achievers with reliable knowledge that propels research and enhances lives. Explore our blog to uncover the newest research, insights, and analyses from Guinness Press authors and collaborators.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-8 col-12 col-md-8 col-sm-12  py-5">
                ...
                <div>
                    ...
                    <div class="row">
                        @foreach ($blogs as $b)
                        <a href="{{ route('blog.detail', ['slug' => $b->slug]) }}" class="text-dark">
                            <div class="col-12 mb-4">
                                <div class="card bg-transparent">
                                <img src="{{ $b->thumbnail ? asset($b->thumbnail) : 'https://media.istockphoto.com/id/1159199214/vector/abstract-technology-or-medical-background-with-hexagons-shape-pattern-concepts-and-ideas-for.jpg?s=612x612&w=0&k=20&c=jQXehVyWkaZkkf8--52VP0j8Sks5lPK_c6o2arBctMQ=' }}"
            ...
            <div class="col-lg-4 col-12 col-md-4 col-sm-12 py-5">
                <div class="mb-4">
                    <div class="card text-white" style="background-color: #184888; border-raduis:10px;">
                        <div class="card-body">
                            ...
                            <p>Don’t miss out on the opportunity to be a part of the Guinness Press family. Subscribe to our newsletter today and stay at the forefront of academic excellence.</p>
                ...
                <div class="mb-4">
                    <div class="card">
                        <img src="https://img.freepik.com/free-vector/connected-world-concept-illustration_114360-3027.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1721001600&semt=sph" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-1">
                                <a href="https://www.facebook.com/groups/1011564960476786/" class="btn btn-blue btn-light w-50">
